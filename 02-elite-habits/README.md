...
- **Business Logic Engine** : Calcul dynamique et automatique d'un score de progression globale (0-100%) basé sur le ratio d'habitudes complétées.

## ✨ Fonctionnalités
- **Dashboard de Progression** : Visualisation du score de succès global de la journée.
- **Grille Hebdomadaire** : Suivi visuel (Lundi à Dimanche) pour chaque habitude créée.
- **Ajout/Suppression** : Gestion dynamique de la liste des disciplines.
- **Responsive Design** : Interface épurée et moderne optimisée avec Tailwind CSS.